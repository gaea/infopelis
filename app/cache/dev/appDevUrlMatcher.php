...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/actorDetail') && preg_match('#^/actorDetail/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'gaea_movies_infopelis_actor_detail')), array (  '_controller' => 'Gaea\\Bundle\\Movies\\InfopelisBundle\\Controller\\SearchController::actorDetailAction',));
        }
